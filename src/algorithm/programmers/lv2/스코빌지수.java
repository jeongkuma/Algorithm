 ...
 * [Heap/힙]
 *
 * 매운 것을 좋아하는 Leo는 모든 음식의 스코빌 지수를 K 이상으로 만들고 싶습니다. 모든 음식의 스코빌 지수를 K 이상으로 만들기 위해 Leo는 스코빌 지수가 가장 낮은 두 개의 음식을 아래와 같이
...
//        pracite(new int[]{1, 2, 3, 9, 10, 12}, 7);
        pracite(new int[]{1, 2, 2, 2, 2, 2}, 419);
    }
    public static int pracite(int[] scoville, int K) {
        int answer = 0;
